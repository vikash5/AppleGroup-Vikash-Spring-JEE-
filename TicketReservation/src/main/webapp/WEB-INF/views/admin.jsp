...
<body>
   ...
   <form action="movietiming" method="post">
		<input type="submit" value="MovieTiming" />
	</form>
	...
	<form action="registrationstatus" method="post">
		<input type="submit" value="satus" />
	</form>
	<form action="ticket type" method="post">
		<input type="submit" value="typeof tickets" />
	</form>
