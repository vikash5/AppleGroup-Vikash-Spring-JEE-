...
CREATE TABLE `reservation` (
  ...
  `reservation_count` varchar(45) DEFAULT NULL,
  `reservation_date` varchar(45) DEFAULT NULL,
  `createddate` varchar(45) DEFAULT NULL,
  `updateddate` varchar(45) DEFAULT NULL,
  `reservation seat_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_reservation_reservation seat1_idx` (`reservation seat_id`),
  CONSTRAINT `fk_reservation_reservation seat1` FOREIGN KEY (`reservation seat_id`) REFERENCES `reservation seat` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
